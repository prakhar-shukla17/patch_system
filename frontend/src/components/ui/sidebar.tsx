...
export const DesktopSidebar = ({
  ...
  return (
    <>
      <motion.div
        className={cn(
          "h-full px-4 py-4 hidden md:flex md:flex-col bg-blue-800 !bg-blue-800 dark:bg-blue-800 w-[300px] shrink-0 sidebar-blue",
          className
        )}
...
export const MobileSidebar = ({
  ...
  return (
    <>
      <div
        className={cn(
          "h-10 px-4 py-4 flex flex-row md:hidden items-center justify-between bg-blue-800 !bg-blue-800 dark:bg-blue-800 w-full sidebar-blue"
        )}
        style={{ backgroundColor: '#1e40af' }}
        {...props}
      >
